...
{
    public class AssessmentFactorEntity : BusinessEntityInterfaces.BusinessEntity
    {
        ...
        public AssessmentFactorEntity()
            : base()
        {
	    InitializeFields();
        }

        public AssessmentFactorEntity(PayanarCommon.IParent parent)
            : base(parent)
        {
	    InitializeFields();
        }
