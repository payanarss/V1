    ...
    public class AssessmentFactorPresentationEntityFactory : PresentationEntityFactory
    {
        ...
        public static IPresentationEntityFactory Factory
        {
            get
            {
                if (_factory == null)
                {
                    _factory = new AssessmentFactorPresentationEntityFactory();
                }
