...
{
    public class PayanarApplicationPresentationEntityCollectionFactory : PresentationEntityCollectionFactory
    {
        ...
        public static IPresentationEntityCollectionFactory Factory
        {
            get
            {
                if (_factory == null)
                {
                    _factory = new PayanarApplicationPresentationEntityCollectionFactory();
                }
        ...
        {
            return new PayanarApplicationPresentationEntityCollection(presenter);
        }

        protected override IPresentationEntityCollection Create(IPresenter presenter, IParent parent)
        {
            return new PayanarApplicationPresentationEntityCollection(presenter, parent);
        }

        protected override IPresentationEntityCollection Create(IObserver observer, IPresenter presenter, IParent parent)
        {
            return new PayanarApplicationPresentationEntityCollection(observer, presenter, parent);
        }
    }
}
