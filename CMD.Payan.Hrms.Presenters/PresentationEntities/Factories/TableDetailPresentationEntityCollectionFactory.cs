...
{
    public class TableDetailPresentationEntityCollectionFactory : PresentationEntityCollectionFactory
    {
        ...
        public static IPresentationEntityCollectionFactory Factory
        {
            get
            {
                if (_factory == null)
                {
                    _factory = new TableDetailPresentationEntityCollectionFactory();
                }
        ...
        {
            return new TableDetailPresentationEntityCollection(presenter, businessObjectCollection);
        }

        protected override IPresentationEntityCollection Create(IPresenter presenter)
        {
            return new TableDetailPresentationEntityCollection(presenter);
        }

        protected override IPresentationEntityCollection Create(IPresenter presenter, IParent parent)
        {
            return new TableDetailPresentationEntityCollection(presenter, parent);
        }

        protected override IPresentationEntityCollection Create(IObserver observer, IPresenter presenter, IParent parent)
        {
            return new TableDetailPresentationEntityCollection(observer, presenter, parent);
        }
    }
}
